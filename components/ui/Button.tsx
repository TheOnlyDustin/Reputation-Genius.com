    ...
    'inline-flex items-center justify-center whitespace-nowrap font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
    {
        variants: {
            variant: {
                ...
                cta: 'bg-primary-gradient text-white font-bold px-6 py-3 rounded-lg shadow-lg hover:shadow-glow hover:-translate-y-0.5',
                'cta-secondary': 'bg-white text-primary hover:bg-gray-50 font-bold px-6 py-3 rounded-lg shadow-md hover:shadow-lg hover:-translate-y-0.5',
            },
            size: {
