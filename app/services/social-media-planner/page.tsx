...
export default function SocialMediaPlannerPage() {
    const features = [
        {
            icon: <Calendar className="icon-feature" />,
        ...
        {
            icon: <Clock className="icon-feature" />,
            title: "Smart Timing",
        ...
        {
            icon: <Share2 className="icon-feature" />,
        ...
        {
            icon: <BarChart className="icon-feature" />,
        ...
        {
            icon: <CheckCircle className="icon-feature" />,
            ...
            <section className="relative overflow-hidden bg-hero-gradient pt-24 pb-32">
                ...
                <div className="section-container relative z-10 text-center">
                    <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-50 text-primary font-medium text-sm mb-6 border border-blue-100">
                        <Calendar className="icon-button mr-2 fill-current" />
                    ...
                    <div className="flex flex-col gap-6 lg:gap-3 justify-center items-center lg:flex-row">
                        <WebchatDemo />
                        <a
                            href="https://link.reputation-genius.com/widget/bookings/discovery-call-ai-agents?utm_source=website&utm_medium=cta&utm_campaign=social-media-planner"
                            target="_blank"
                            ...
                            <ul className="space-y-4">
                                {[
                                    ...
                                    <li key={index} className="flex items-center text-lg text-text-secondary">
                                        <CheckCircle className="icon-small text-green-500 mr-3 flex-shrink-0" />
                                        {item}
                                    </li>
                                ))}
                            </ul>
