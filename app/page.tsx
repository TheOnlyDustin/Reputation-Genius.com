                ...
                <ul className="space-y-4 mb-8">
                  {tier.features.map((feature, i) => (
                    <li key={i} className="flex items-start">
                      <CheckCircle className="icon-mini mr-3 mt-0.5 flex-shrink-0 text-secondary group-hover:text-primary group-hover:drop-shadow-[0_0_6px_rgba(15,82,186,0.8)] transition-all duration-300" />
